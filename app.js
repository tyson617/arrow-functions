...
let sum = (n1, n2, n3, n4) => `${n1 + n2 + n3 + n4}`;

// TODO: Uncomment the following line of code to see the output in the browser console
// console.log(sum(1, 2, 3, 4));
console.log('Add as a oneliner:', sum(1,2,3,4));
...
//    "this" refers to the joe object. In the context of the scope method, defined on the Student prototype.
// 2. What is "this" when joe.scopeArrow() is invoked?
//    "this" refers to the global context, therefore, not referencing the joe object.
// 3. Explain why "this" is different when an arrow function is used.
//    Arrow functions don't have their own "this," instead, they lexically bind, meaning they capture the "this" value from the surrounding code at the time they're defined. This makes arrow functions useful when you want to preserve the context of "this", such as in callbacks or within methods where you want to maintain the original object context.
